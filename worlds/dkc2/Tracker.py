...
from worlds.dkc2.Options import DKC2Options
...
class UTMxin(World):
    ...
    def generate_early(self) -> None:
        ...
        if re_gen_passthrough and self.game in re_gen_passthrough:
            slot_data: dict[str,Any] = self.multiworld.re_gen_passthrough["Donkey Kong Country 2"]
            self.level_connections = slot_data["level_connections"]
            self.boss_connections = slot_data["boss_connections"]
            self.options.goal.value = slot_data["goal"]
            self.options.required_galleon_levels.value = slot_data["required_galleon_levels"]
            self.options.required_cauldron_levels.value = slot_data["required_cauldron_levels"]
            self.options.required_quay_levels.value = slot_data["required_quay_levels"]
            self.options.required_kremland_levels.value = slot_data["required_kremland_levels"]
            self.options.required_gulch_levels.value = slot_data["required_gulch_levels"]
            self.options.required_keep_levels.value = slot_data["required_keep_levels"]
            self.options.required_krock_levels.value = slot_data["required_krock_levels"]
            self.options.logic.value = slot_data["logic"]
            self.options.starting_kong.value = slot_data["starting_kong"]
            self.options.lost_world_rocks.value = slot_data["lost_world_rocks"]
            self.options.krock_boss_tokens.value = slot_data["krock_boss_tokens"]
            self.options.shuffle_abilities.value = slot_data["shuffled_abilities"]
            self.options.shuffle_animals.value = slot_data["shuffled_animals"]
            self.options.shuffle_barrels.value = slot_data["shuffled_barrels"]
            self.options.kong_checks.value = slot_data["kong_checks"]
            self.options.dk_coin_checks.value = slot_data["dk_coin_checks"]
            self.options.swanky_checks.value = slot_data["swanky_checks"]
            self.options.balloonsanity.value = slot_data["balloonsanity"]
            self.options.coinsanity.value = slot_data["coinsanity"]
            self.options.bananasanity.value = slot_data["bananasanity"]
