...
location_groups = {
    "1-1 Jungle Hijinxs": {location for location in all_locations.keys() if "Jungle Hijinxs" in location},
    "1-2 Ropey Rampage": {location for location in all_locations.keys() if "Ropey Rampage" in location},
    "1-3 Reptile Rumble": {location for location in all_locations.keys() if "Reptile Rumble" in location},
    "1-4 Coral Capers": {location for location in all_locations.keys() if "Coral Capers" in location},
    "1-5 Barrel Cannon Canyon": {location for location in all_locations.keys() if "Barrel Cannon Canyon" in location},
    "1-B Very Gnawty's Lair": {
        LocationName.very_gnawty_lair_clear,
        LocationName.defeated_gnawty_1,
    },
    "2-1 Winky's Walkway": {location for location in all_locations.keys() if "Winky's Walkway" in location},
    "2-2 Mine Cart Carnage": {location for location in all_locations.keys() if "Mine Cart Carnage" in location},
    "2-3 Bouncy Bonanza": {location for location in all_locations.keys() if "Bouncy Bonanza" in location},
    "2-4 Stop & Go Station": {location for location in all_locations.keys() if "Stop & Go Station" in location},
    "2-5 Millstone Mayhem": {location for location in all_locations.keys() if "Millstone Mayhem" in location},
    "2-B Necky's Nuts": {
        LocationName.necky_nuts_clear,
        LocationName.defeated_necky_1,
    },
    "3-1 Vulture Culture": {location for location in all_locations.keys() if "Vulture Culture" in location},
    "3-2 Tree Top Town": {location for location in all_locations.keys() if "Tree Top Town" in location},
    "3-3 Forest Frenzy": {location for location in all_locations.keys() if "Forest Frenzy" in location},
    "3-4 Temple Tempest": {location for location in all_locations.keys() if "Temple Tempest" in location},
    "3-5 Orang-utan Gang": {location for location in all_locations.keys() if "Orang-utan Gang" in location},
    "3-6 Clam City": {location for location in all_locations.keys() if "Clam City" in location},
    "3-B Bumble B Rumble": {
        LocationName.bumble_b_rumble_clear,
        LocationName.defeated_bumble_b,
    },
    "4-1 Snow Barrel Blast": {location for location in all_locations.keys() if "Snow Barrel Blast" in location},
    "4-2 Slipslide Ride": {location for location in all_locations.keys() if "Slipslide Ride" in location},
    "4-3 Ice Age Alley": {location for location in all_locations.keys() if "Ice Age Alley" in location},
    "4-4 Croctopus Chase": {location for location in all_locations.keys() if "Croctopus Chase" in location},
    "4-5 Torchlight Trouble": {location for location in all_locations.keys() if "Torchlight Trouble" in location},
    "4-6 Rope Bridge Rumble": {location for location in all_locations.keys() if "Rope Bridge Rumble" in location},
    "4-B Really Gnawty Rampage": {
        LocationName.really_gnawty_rampage_clear,
        LocationName.defeated_gnawty_2,
    },
    "5-1 Oil Drum Alley": {location for location in all_locations.keys() if "Oil Drum Alley" in location},
    "5-2 Trick Track Trek": {location for location in all_locations.keys() if "Trick Track Trek" in location},
    "5-3 Elevator Antics": {location for location in all_locations.keys() if "Elevator Antics" in location},
    "5-4 Poison Pond": {location for location in all_locations.keys() if "Poison Pond" in location},
    "5-5 Mine Cart Madness": {location for location in all_locations.keys() if "Mine Cart Madness" in location},
    "5-6 Blackout Basement": {location for location in all_locations.keys() if "Blackout Basement" in location},
    "5-B Boss Dumb Drum": {
        LocationName.boss_dumb_drum_clear,
        LocationName.defeated_boss_dumb_drum,
    },
    "6-1 Tanked Up Trouble": {location for location in all_locations.keys() if "Tanked Up Trouble" in location},
    "6-2 Manic Mincers": {location for location in all_locations.keys() if "Manic Mincers" in location},
    "6-3 Misty Mine": {location for location in all_locations.keys() if "Misty Mine" in location},
    "6-4 Loopy Lights": {location for location in all_locations.keys() if "Loopy Lights" in location},
    "6-5 Platform Perils": {location for location in all_locations.keys() if "Platform Perils" in location},
    "6-B Necky's Revenge": {
