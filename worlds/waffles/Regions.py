...
def create_regions(world: "WaffleWorld", active_locations: typing.Dict[int,int]):
    ...
    if world.options.room_checks:
         ...
         add_location_to_region(world, active_locations, LocationName.donut_plains_castle_region, LocationName.green_switch_palace_room_1)
         add_location_to_region(world, active_locations, LocationName.donut_plains_castle_region, LocationName.green_switch_palace_room_2)
