...
def create_regions(world: "WaffleWorld", active_locations: typing.Dict[int,int]):
    ...
    if world.options.bonus_block_checks:
        add_location_to_region(world, active_locations, LocationName.yoshis_island_3_region, LocationName.yoshis_island_3_bonus_block)
        add_location_to_region(world, active_locations, LocationName.donut_plains_3_region, LocationName.donut_plains_3_bonus_block)
        add_location_to_region(world, active_locations, LocationName.butter_bridge_1_region, LocationName.butter_bridge_1_bonus_block)
        add_location_to_region(world, active_locations, LocationName.chocolate_island_3_region, LocationName.chocolate_island_3_bonus_block)
