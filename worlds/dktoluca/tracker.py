...
class UTMxin(World):
    ...
    def generate_early(self) -> None:
        ...
        if re_gen_passthrough and self.game in re_gen_passthrough:
            ...
            self.trade_items = slot_data["trade_items"]
            self.options.goal.value = slot_data["goal"]
            self.options.swap_krool.value = slot_data["swap_krool"]
            ...
            self.options.kong_locations.value = slot_data["kong_locations"]
            self.options.dk_coin_locations.value = slot_data["dk_coin_locations"]
            self.options.balloon_locations.value = slot_data["balloon_locations"]
            self.options.banana_locations.value = slot_data["banana_locations"]
            self.options.coin_locations.value = slot_data["coin_locations"]
            self.options.bird_locations.value = slot_data["bird_locations"]
            self.options.swanky_locations.value = slot_data["swanky_locations"]
            self.options.vehicle_unlock.value = slot_data["vehicle_unlock"]
