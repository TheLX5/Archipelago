...
class TengokuProcedurePatch(APProcedurePatch, APTokenMixin):
    hash = [HASH_JP]
    game = GAME_NAME
    patch_file_ending = ".aptengoku"
...
def patch_rom(world: "TengokuWorld", patch: TengokuProcedurePatch):
...
def get_base_rom_path(file_name: str = "") -> str:
    if not file_name:
        ...
        file_name = get_settings()["rhythm_tengoku_options"]["rom_file"]
