...
def balanced_shuffle(multiworld: MultiWorld, fill_locations: list[Location], itempool: list[Item],
    ...
    print (f"Progression Equalization: {equalization_percentage}%")
...
def distribute_items_restrictive(multiworld: MultiWorld,
    ...
    print (f"Excluded locations: {len(excludedlocations)}")
    print (f"Priority locations: {len(prioritylocations)}")
    ...
    if prioritylocations:
        ...
        print (f"Regular progression: {len(regular_progression)}")
        print (f"Deprioritized progression: {len(deprioritized_progression)}")
